...
import concreteFlyweight.ButtonListener;
...
public class FlyweightFactory {
    ...
    public static Button makeButton(String num) {
        ...
        if (treeMap.containsKey(num)) {
            // 3. Identify intrinsic state (Button label)
            /* 4. Return an existing object   [The same Button cannot be added
            * multiple times to a container, and, Buttons cannot be cloned.
            * So - this is only simulating the sharing that the Flyweight pattern provides.]
            */
