...
public class StrategyTest {
	...
	public static void main(String[] args) {
		...
		payment = new PaymentByCreditCard("Maurício Serrano", "4073.0200.0000.0002", 111, date);
		...
		payment = new PaymentByBankingBillet("Milene Serrano", "Americanas.com", "40730.02000 00000.000234 12345.678900 3 33390000038055", date);
		shoppingContext.pay(payment);
